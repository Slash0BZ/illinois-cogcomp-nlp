...
// discrete f3$$0$0(Token w) <- labelOrBaseline && labelTwoBefore
...
public class f3$$0$0 extends Classifier
{
  ...
  public Feature featureValue(Object __example)
  {
    if (!(__example instanceof Token))
    {
      ...
      System.err.println("Classifier 'f3$$0$0(Token)' defined on line 156 of POSKnown.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "f3$$0$0".hashCode(); }
  public boolean equals(Object o) { return o instanceof f3$$0$0; }
}
