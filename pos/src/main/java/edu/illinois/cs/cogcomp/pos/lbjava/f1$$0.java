...
// discrete f1$$0(Token w) <- labelOrBaseline && labelOneBefore
...
public class f1$$0 extends Classifier
{
  ...
  public Feature featureValue(Object __example)
  {
    if (!(__example instanceof Token))
    {
      ...
      System.err.println("Classifier 'f1$$0(Token)' defined on line 150 of POSKnown.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "f1$$0".hashCode(); }
  public boolean equals(Object o) { return o instanceof f1$$0; }
}
