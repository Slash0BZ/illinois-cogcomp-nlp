...
public class bio_classifier_namc extends SupportVectorMachine
{
    private static void loadInstance()
    {
        if (instance == null) instance = new bio_classifier_namc(true);
    }
    ...
    public static bio_classifier_namc instance;

    public static bio_classifier_namc getInstance()
    {
        loadInstance();
        return instance;
    }

    private bio_classifier_namc(boolean b)
    {
        super(new Parameters());
        containingPackage = "org.cogcomp.md.LbjGen";
        name = "bio_classifier_namc";
        setEncoding(null);
        setLabeler(new bio_label());
        setExtractor(new bio_classifier_namc$$1());
        isClone = false;
    }
    ...
    public bio_classifier_namc()
    {
        super("org.cogcomp.md.LbjGen.bio_classifier_namc");
        isClone = true;
    }

    public bio_classifier_namc(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

    public bio_classifier_namc(Parameters p, String modelPath, String lexiconPath) {
        super(p);
        try {
        ...
        else if (IOUtilities.existsInClasspath(bio_classifier_namc.class, modelPath)) {
            System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
            readModel(IOUtilities.loadFromClasspath(bio_classifier_namc.class, modelPath));
            readLexiconOnDemand(IOUtilities.loadFromClasspath(bio_classifier_namc.class, lexiconPath));
        }
        else {
            containingPackage = "org.cogcomp.md.LbjGen";
            name = "bio_classifier_namc";
    ...
    public void learn(Object example)
    {
        if (isClone)
        {
            if (!(example instanceof Constituent || example instanceof Object[]))
            {
                ...
                System.err.println("Classifier 'bio_classifier_namc(Constituent)' defined on line 204 of md.lbj received '" + type + "' as input.");
    ...
    public static void main(String[] args)
    {
        ...
        {
            System.err.println("usage: org.cogcomp.md.LbjGen.bio_classifier_namc \\");
    ...
    public int hashCode() { return "bio_classifier_namc".hashCode(); }
    public boolean equals(Object o) { return o instanceof bio_classifier_namc; }
