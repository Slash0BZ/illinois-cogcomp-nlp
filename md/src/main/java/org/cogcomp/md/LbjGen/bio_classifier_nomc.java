...
public class bio_classifier_nomc extends SupportVectorMachine
{
    private static void loadInstance()
    {
        if (instance == null) instance = new bio_classifier_nomc(true);
    }
    ...
    public static bio_classifier_nomc instance;

    public static bio_classifier_nomc getInstance()
    {
        loadInstance();
        return instance;
    }

    private bio_classifier_nomc(boolean b)
    {
        super(new Parameters());
        containingPackage = "org.cogcomp.md.LbjGen";
        name = "bio_classifier_nomc";
        setEncoding(null);
        setLabeler(new bio_label());
        setExtractor(new bio_classifier_nomc$$1());
        isClone = false;
    }
    ...
    public bio_classifier_nomc()
    {
        super("org.cogcomp.md.LbjGen.bio_classifier_nomc");
        isClone = true;
    }

    public bio_classifier_nomc(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

    public bio_classifier_nomc(Parameters p, String modelPath, String lexiconPath) {
        super(p);
        try {
        ...
        else if (IOUtilities.existsInClasspath(bio_classifier_nomc.class, modelPath)) {
            System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
            readModel(IOUtilities.loadFromClasspath(bio_classifier_nomc.class, modelPath));
            readLexiconOnDemand(IOUtilities.loadFromClasspath(bio_classifier_nomc.class, lexiconPath));
        }
        else {
            containingPackage = "org.cogcomp.md.LbjGen";
            name = "bio_classifier_nomc";
    ...
    public void learn(Object example)
    {
        if (isClone)
        {
            if (!(example instanceof Constituent || example instanceof Object[]))
            {
                ...
                System.err.println("Classifier 'bio_classifier_nomc(Constituent)' defined on line 217 of md.lbj received '" + type + "' as input.");
    ...
    public static void main(String[] args)
    {
        ...
        {
            System.err.println("usage: org.cogcomp.md.LbjGen.bio_classifier_nomc \\");
    ...
    public int hashCode() { return "bio_classifier_nomc".hashCode(); }
    public boolean equals(Object o) { return o instanceof bio_classifier_nomc; }
