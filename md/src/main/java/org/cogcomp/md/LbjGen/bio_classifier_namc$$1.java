...
public class bio_classifier_namc$$1 extends Classifier
{
    ...
    public bio_classifier_namc$$1()
    {
        containingPackage = "org.cogcomp.md.LbjGen";
        name = "bio_classifier_namc$$1";
    }
    ...
    public FeatureVector classify(Object __example)
    {
        if (!(__example instanceof Constituent))
        {
            ...
            System.err.println("Classifier 'bio_classifier_namc$$1(Constituent)' defined on line 205 of md.lbj received '" + type + "' as input.");
    ...
    public int hashCode() { return "bio_classifier_namc$$1".hashCode(); }
    public boolean equals(Object o) { return o instanceof bio_classifier_namc$$1; }
